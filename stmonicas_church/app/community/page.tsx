...
const locations = [
    { type: 'School', name: 'SHHS', href: '/schools/shhs', image: '/hero_one.svg', alt: 'SHHS School Building' },
    { type: 'School', name: 'HFHS', href: '/schools/hfhs', image: '/hero_five.svg', alt: 'HFHS School Building' },
    { type: 'School', name: 'Primary School', href: '/schools/primary', image: '/hero_three.svg', alt: 'Primary School Building' },
    { type: 'Clinic', name: 'Clinic', href: '/clinic', image: '/hero_two.svg', alt: 'Community Clinic' },
    { type: 'Church', name: 'Church', href: '/church', image: '/hero_four.svg', alt: 'Church Building' },
  ];
        ...
        <main className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 text-gray-800">
              ...
              <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-4 animate-slide-up">
                {locations
                  ...
                  .map(({ name, href, image }) => (
                    ...
                    >
                      <Card title={name} image={image || '/default_location.svg'}>
          ...
          <section className="py-16 bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-4 animate-slide-up">
              <Card title="Youth Fellowship" image="/hero_five.svg" alt="Youth Fellowship">
              ...
              <Card title="Women’s Ministry" image="/hero_one.svg" alt="Women's Ministry">
                <ul className="list-disc list-inside text-gray-700">
              ...
              <Card title="Men’s Ministry" image="/hero_two.svg" alt="Men's Ministry">
                <ul className="list-disc list-inside text-gray-700">
